 ...
 * 2017-01-20T14:31:49.029+02:00
 * Generated source version: 3.1.9
 * 
 */
@WebServiceClient(name = "FirstService", 
                  wsdlLocation = "file:/C:/dev/project/tests/soap_server/spring_boot_soap/src/main/webapp/WEB-INF/wsdl/First.wsdl",
...
public class FirstService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/dev/project/tests/soap_server/spring_boot_soap/src/main/webapp/WEB-INF/wsdl/First.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(FirstService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/dev/project/tests/soap_server/spring_boot_soap/src/main/webapp/WEB-INF/wsdl/First.wsdl");
        }
        WSDL_LOCATION = url;
    }
